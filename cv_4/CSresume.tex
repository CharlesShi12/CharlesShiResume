...
\item Created a similarity search algorithm called MedSearch that takes in the abstract of any COVID-19 research paper and returns other similar COVID-19 research papers to advance coronavirus research.
\vspace{1mm}
