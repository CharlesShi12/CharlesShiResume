...
\vspace{1mm}
\item Obtained Synthea-generated patient data and computed patient statistics by writing multiple GSQL queries in TigerGraph and programmed the dashboard along with the data visualizations using Dash and Plotly.
\end{itemize}
\vspace{-2.5mm}
