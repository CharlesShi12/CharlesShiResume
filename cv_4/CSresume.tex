...
\begin{itemize}[leftmargin=6.25mm] \itemsep -2pt 
\item  Created a full-stack application that takes in any research paper and outputs similar COVID-19 research papers using Natural Language Processing and graph databases (stored over \textbf{1,000,000} edges and \textbf{350,000} nodes).
\vspace{1.30mm}
