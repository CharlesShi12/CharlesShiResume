...
\vspace{.75mm}
\item Applied PPM raster image formatting and constructed a k-means clustering algorithm to group the pixels of an inputted image into dominant colors and filter/reduce the image based on those colors. 
\end{itemize}
\section{SKILLS} 
{\sl Languages:} 
