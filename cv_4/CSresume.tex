...
\pdfgentounicode=1
\resumewidth = 7.34in 
\geometry{left=.58in, top=.40in, right=.58in, bottom=.42in}
\newsectionwidth{0pt}  
\linespread{1.1} 
\begin{document} 
\begin{footnotesize}
...
\vspace{1.30mm}
\item Placed \textbf{1st} out of more than \textbf{100} participants in the University of Minnesota's annual hackathon. 
\end{itemize}
\vspace{-2.5mm}
