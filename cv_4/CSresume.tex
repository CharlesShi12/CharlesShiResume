...
\end{small} 
\vspace{.5mm}
\href{https://github.com/CharlesShi12/CalcShare}{\textbf{CalcShare}} — {\sl Kotlin, Javalin, JavaScript, HTML/CSS, Web Server/Client, WebSockets, APIs} \hfill August 2020\vspace{-4.75mm}
\begin{itemize} \itemsep -2pt 
