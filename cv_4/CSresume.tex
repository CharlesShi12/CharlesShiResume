...
\item Created a similarity search algorithm called MedSearch that takes in the abstract of any research paper and outputs the most similar COVID-19 research papers to advance COVID-19 research.
\vspace{1mm}
