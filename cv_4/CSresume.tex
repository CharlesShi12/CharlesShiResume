...
\vspace{1mm}
\item Created custom curriculum tailored to each student's needs and designed/planned final projects that assessed the students' problem solving skills while incorporating their interests and curiosities. 
\end{itemize}
\begin{small}
\section{PROJECTS}
\end{small} 
