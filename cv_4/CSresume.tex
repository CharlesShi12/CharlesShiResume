...
\pdfgentounicode=1
\resumewidth = 7.34in 
\geometry{left=.58in, top=.46in, right=.58in, bottom=.47in}
\newsectionwidth{0pt}  
\linespread{1.1} 
\begin{document} 
\begin{footnotesize}
...
\vspace{1.30mm}
\item Utilized a snapshot listener and APIs which connects the React frontend with the Firebase backend to produce synchronous updates between authenticated users. 
\vspace{1.30mm}
\item Ranked \textbf{1st} in the food category out of more than \textbf{100} participants at the University of Minnesota's 2021 Hackathon. 
\end{itemize}
\vspace{-2.5mm}
