...
Responsible for designing impactful projects that use TigerGraph's graph database and presenting the finished projects to a group of businesses ranging from startups to Fortune 500 companies.
...
\vspace{-5mm}
\begin{itemize} \itemsep -2pt 
\item Utilized Dash and Plotly to develop a personalized patient dashboard that gives doctors and researchers an in-depth analysis of synthetic patient data through informative visualizations and statistics. 
\vspace{1mm}
