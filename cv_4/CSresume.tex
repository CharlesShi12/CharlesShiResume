...
\pdfgentounicode=1
\resumewidth = 7.34in 
\geometry{left=.58in, top=.42in, right=.58in, bottom=.44in}
\newsectionwidth{0pt}  
\linespread{1.1} 
\begin{document} 
\begin{footnotesize}
...
\end{small} 
\vspace{.5mm}
\href{https://devpost.com/software/pickup-7b8yhx}{\textbf{Pickup}} — {\sl React, HTML/CSS, MapBox GL, Firebase, APIs}\hfill \textbf{1st Place}, University of Minnesota's 2021 Hackathon\vspace{-5mm}
\begin{itemize}[leftmargin=6.25mm] \itemsep -2pt 
...
\end{itemize}
\vspace{-2.5mm}
\href{https://github.com/CharlesShi12/ImageFilters}{\textbf{Image Filter}} — {\sl Python, Machine Learning, PPM Image Format} \vspace{-5mm}
\begin{itemize}[leftmargin=6.25mm] \itemsep -2pt 
