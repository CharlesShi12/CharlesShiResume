...
\end{itemize}
\section{PROJECTS} 
\textbf{\href{https://github.com/CharlesShi12/CalcShare}{Real-Time Collaborative Calculator}} \hfill August 2020\vspace{-5.25mm}
\begin{itemize} \itemsep -2pt 
...
\vspace{.75mm}
\item Developed a JavaScript client to communicate with the server, implemented WebSockets to effectively deal with the constant influx of data, and interacted with a RESTful API to compute equations inputted by the user.  
\end{itemize}
\vspace{-2.5mm}
\textbf{\href{https://github.com/CharlesShi12/Medical_Scanner}{AI Tumor Scanner}}   \hfill July 2020\vspace{-5.25mm}
\begin{itemize} \itemsep -2pt 
...
\end{itemize}
\vspace{-2.5mm}
\textbf{\href{https://github.com/CharlesShi12/EnglishLikeWords}{Gibberish Generator}} \hfill May 2020\vspace{-5.25mm}
\begin{itemize} \itemsep -2pt 
...
\end{itemize}
\vspace{-2.5mm}
\textbf{\href{https://github.com/CharlesShi12/ImageFilters}{Image Filtering System}} \hfill March 2020\vspace{-5.25mm}
\begin{itemize} \itemsep -2pt
