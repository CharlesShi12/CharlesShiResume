...
\vspace{.75mm}
\item Applied PPM raster image formatting and constructed a k-means algorithm to group the pixels of an inputted image into dominant color clusters and filter/reduce the image based on those clusters. 
\end{itemize}
\section{SKILLS} 
{\sl Languages:} 
