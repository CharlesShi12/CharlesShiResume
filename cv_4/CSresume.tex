...
\usepackage{hyperref}
\resumewidth = 7.2in 
\geometry{left=.65in, top=.44in, right=.65in, bottom=.46in}
\newsectionwidth{0pt}  
\begin{document} 
\begin{footnotesize}
...
\end{small}
\vspace{.5mm}
\textbf{Futurist Academy} {\sl Software Developer Intern} \hfill July 2020 - September 2020\vspace{-4mm}
...
\end{small} 
\vspace{.5mm}
\href{https://github.com/CharlesShi12/CalcShare}{\textbf{Real-Time Editing Calculator}} {\sl Kotlin, JavaScript, HTML/CSS, WebSockets, APIs} \hfill August 2020\vspace{-4.75mm}
\begin{itemize} \itemsep -2pt 
